...
const FactorRow = ({
  ...
  style: {
    fontSize: 11.5,
    color: dim ? "var(--text-mid)" : "var(--text)"
  }
  ...
  value: v,
  w: 48,
  color: dim ? "var(--text-mid)" : "var(--signal)",
  label: false
}), /*#__PURE__*/React.createElement("span", {
  className: "mono tnum",
  style: {
...
const FormatCard = ({
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    style: {
      ...
      paddingTop: 10,
      display: "grid",
      gridTemplateColumns: meta.length === 3 ? "1fr 1fr 1fr" : "1fr 1fr",
      gap: 8
    }
  ...
  }, gen.state === "generating" && /*#__PURE__*/React.createElement("div", {
    style: {
      display: "flex",
      alignItems: "center",
      gap: 8,
  ...
  }), "Writing\u2026"), gen.state === "error" && /*#__PURE__*/React.createElement("div", {
    style: {
      color: "var(--signal-down)",
      fontSize: 12
    }
  }, "Generation failed \u2014 check that ANTHROPIC_API_KEY is set."), gen.state === "done" && gen.text && /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("pre", {
    className: "mono",
    style: {
      whiteSpace: "pre-wrap",
  ...
  }, gen.text), /*#__PURE__*/React.createElement("div", {
    style: {
      display: "flex",
      gap: 6
    }
    ...
    className: "btn ghost",
    onClick: () => navigator.clipboard?.writeText(gen.text)
  }, "Copy"), /*#__PURE__*/React.createElement("button", {
    className: "btn ghost",
    onClick: () => window.downloadScript(`${format}_${tag.toLowerCase()}.md`, `# ${title}\n\nFormat: ${tag} · ${eyebrow}\n\n${gen.text}`)
    ...
    style: {
      display: "flex",
      gap: 6,
      marginTop: gen.state === "idle" ? "auto" : 0
    }
  }, /*#__PURE__*/React.createElement("button", {
    className: "btn ghost",
    style: {
  ...
  }, gen.state === "generating" ? "Writing…" : gen.state === "done" ? "Regenerate" : cta, gen.state !== "generating" && /*#__PURE__*/React.createElement(I.ArrowR, {
    size: 11
  }))));
};
...
const ShortsReel = ({
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    no: "02",
    actions: cards ? /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("span", {
      className: "mono",
      style: {
        fontSize: 10,
        color: "var(--text-lo)",
    ...
    }, gen.state === "generating" ? "Generating…" : "Regenerate")) : /*#__PURE__*/React.createElement("button", {
      className: "btn primary",
      disabled: gen.state === "generating",
      onClick: gen.generate
    }, gen.state === "generating" ? "Generating…" : "Generate short ideas")
  }, "Shorts deck \xB7 swipe to pick"), !cards && /*#__PURE__*/React.createElement("div", {
    style: {
      padding: "40px 20px",
      textAlign: "center"
    }
  ...
  }), "Writing 5 hook ideas from live data\u2026") : gen.state === "error" ? /*#__PURE__*/React.createElement("div", {
    style: {
      color: "var(--signal-down)",
      fontSize: 13
    }
  }, "Generation failed \u2014 check ANTHROPIC_API_KEY.", /*#__PURE__*/React.createElement("button", {
    className: "btn ghost",
    style: {
      marginLeft: 10
    },
  ...
  }, "No short ideas yet. Click \"Generate short ideas\" to create 5 hooks from today's top story.")), cards && cards.length > 0 && (() => {
    ...
    return /*#__PURE__*/React.createElement("div", {
    ...
    }, "Hook ", idx + 1), /*#__PURE__*/React.createElement("h2", {
      style: {
        fontSize: 32,
        lineHeight: 1.08,
    ...
    }, "\"", currentShort.hook, "\""), /*#__PURE__*/React.createElement("div", {
      style: {
        display: "flex",
        gap: 12,
        alignItems: "center",
      ...
      className: "chip"
    }, "topic \xB7 ", currentShort.topic), /*#__PURE__*/React.createElement("span", {
      className: "chip",
      style: {
        color: "var(--signal)"
      }
    }, "tension ", currentShort.tension), /*#__PURE__*/React.createElement("span", {
      className: "chip",
      style: {
        color: "var(--signal-up)"
      }
    }, "demo ", currentShort.demo)), /*#__PURE__*/React.createElement("div", {
      style: {
        display: "flex",
        gap: 10,
        marginTop: 22
      ...
      className: "btn primary",
      onClick: () => swipe("film")
    }, "Film today ", /*#__PURE__*/React.createElement(I.Play, {
      size: 11
    }))), /*#__PURE__*/React.createElement("div", {
      style: {
        display: "flex",
    ...
    }, cards.map((s, i) => /*#__PURE__*/React.createElement("span", {
      key: s.id,
      style: {
        flex: 1,
        height: 3,
        borderRadius: 2,
        background: decision[s.id] === "film" ? "var(--signal-up)" : decision[s.id] === "later" ? "var(--signal)" : decision[s.id] === "skip" ? "var(--text-lo)" : i === idx ? "var(--text-hi)" : "var(--line-2)"
      }
    })))), /*#__PURE__*/React.createElement("div", {
      style: {
        width: 180,
...
const QuickWins = ({
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    }, !wins && /*#__PURE__*/React.createElement("button", {
      className: "btn primary",
      disabled: gen.state === "generating",
      onClick: gen.generate
    }, gen.state === "generating" ? "Generating…" : "Generate quick wins"), wins && /*#__PURE__*/React.createElement("button", {
      className: "btn ghost",
      disabled: gen.state === "generating",
      onClick: gen.generate
    }, gen.state === "generating" ? "…" : "Regenerate"), /*#__PURE__*/React.createElement("button", {
      className: "btn ghost",
      onClick: () => onJump("pipeline")
    }, "Open pipeline \u2192"))
  }, "Quick wins \xB7 low-effort cross-posts"), !wins && /*#__PURE__*/React.createElement("div", {
    style: {
      padding: "32px 20px",
      textAlign: "center"
    }
  ...
  }), "Finding quick wins from live data\u2026") : gen.state === "error" ? /*#__PURE__*/React.createElement("div", {
    style: {
      color: "var(--signal-down)",
      fontSize: 13
    }
  ...
  }, "Click \"Generate quick wins\" to get 4 low-effort content ideas grounded in today's stories.")), wins && /*#__PURE__*/React.createElement("div", {
    style: {
      display: "grid",
  ...
  }, w.topic), /*#__PURE__*/React.createElement("span", {
    className: "chip"
  ...
  }, w.effort), /*#__PURE__*/React.createElement("span", {
    className: "mono",
    style: {
      fontSize: 10,
...
const BriefView = ({
  ...
  if (!hero) {
    ...
    }, "Today's brief"), /*#__PURE__*/React.createElement("h1", {
      className: "serif",
      style: {
        fontSize: 26,
        color: "var(--text-hi)",
    ...
    }, "Nothing to make yet"), /*#__PURE__*/React.createElement("p", {
      style: {
        color: "var(--text-mid)",
        maxWidth: 420,
        margin: "0 auto 18px"
      }
    }, "The brief picks today's top cross-source story. Fetch sources to populate it."), /*#__PURE__*/React.createElement("button", {
      className: "btn primary",
  ...
  const videoBody = opp?.why_viewers_care || (hero.related_items?.length > 0 ? `${hero.related_items.length} sources are covering this simultaneously — ${hero.why_this_is_a_story || "strong signal for a deep-dive video."}` : hero.why_this_is_a_story || "");
  const shortsBody = opp?.short_script || opp?.opening_hook || `${hero.topic} — ${hero.momentum > 0 ? `momentum ↑${hero.momentum}` : "trending now"} across ${hero.sources?.length || "multiple"} source types.`;
  const linkedinBody = opp?.risks_or_caveats || opp?.recommended_angle || hero.recommended_angle || `Why ${hero.topic} is the story AI professionals need to understand this week.`;
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    actions: /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("span", {
      ...
      style: {
        color: "var(--signal)",
        borderColor: "rgba(240,183,47,0.4)",
  ...
  }, /*#__PURE__*/React.createElement("strong", null, "Heuristic Brief:"), " This brief is currently generated from static heuristics. Run AI Enrichment to synthesize dynamic, AI-structured insights.")), /*#__PURE__*/React.createElement("button", {
    className: "btn primary",
  ...
  }, enriching ? "Enqueuing..." : "✨ Run AI Enrichment")), /*#__PURE__*/React.createElement("div", {
    style: {
      display: "grid",
  ...
  }, /*#__PURE__*/React.createElement("span", null, "Today's pick \xB7 creator score ", hero.creator_score, " \xB7 ", hero.related_items?.length || 0, " items across ", hero.sources?.length || 0, " source types"), hero.affinity_bonus > 0 && /*#__PURE__*/React.createElement("span", {
    className: "chip",
    style: {
      color: "var(--signal-up)",
  ...
  }, "\uD83D\uDCC8 +", hero.affinity_bonus, " ROI Affinity Boost")), /*#__PURE__*/React.createElement("h1", {
    style: {
      fontSize: 46,
      lineHeight: 1.02,
  ...
  }, displayTitle || hero.topic), /*#__PURE__*/React.createElement("p", {
    className: "serif",
    style: {
      fontSize: 19,
      lineHeight: 1.35,
  ...
  }, P.hero_sub, " ", hero.topic, " is the topic where you'll arrive earliest with the most evidence."), Object.keys(titles).length > 0 && /*#__PURE__*/React.createElement("div", {
    style: {
      marginTop: 22
    }
  }, /*#__PURE__*/React.createElement("div", {
    className: "micro"
  }, "Title angle"), /*#__PURE__*/React.createElement("div", {
    style: {
      display: "flex",
      gap: 6,
      marginTop: 8,
  ...
  }, Object.keys(titles).map(k => /*#__PURE__*/React.createElement("button", {
    key: k,
  ...
  }, /*#__PURE__*/React.createElement(BriefBeat, {
    n: "HOOK",
    body: hookText
  }), /*#__PURE__*/React.createElement(BriefBeat, {
    n: "BEAT 1",
    ...
    onClick: () => {
      ...
      window.DDX.saveToPipeline({
        ...
        alert("Saved to pipeline as an idea.");
        window.DDX.reload();
      });
    }
  ...
  }, "Open Thumb Lab")), /*#__PURE__*/React.createElement("div", {
    style: {
      marginTop: 18,
      padding: "12px 14px",
      background: "var(--bg-2)",
  ...
  }, "Why this scored ", hero.creator_score, !opp && /*#__PURE__*/React.createElement("span", {
    style: {
      color: "var(--text-lo)",
      fontWeight: 400,
      marginLeft: 6
    }
  }, "\xB7 estimated from cluster signals")), hero.affinity_bonus > 0 && /*#__PURE__*/React.createElement("div", {
    style: {
      margin: "8px 0 12px 0",
      padding: "8px 10px",
  ...
  }, "\u2728 ", /*#__PURE__*/React.createElement("strong", null, "ROI Loop Affinity Boost:"), " This topic matches top-performing categories from recent publications, receiving an automatic ", /*#__PURE__*/React.createElement("strong", null, "+", hero.affinity_bonus, " boost"), " to its Creator Score."), /*#__PURE__*/React.createElement("div", {
    style: {
      display: "grid",
      gridTemplateColumns: "1fr 1fr",
      gap: 10,
    ...
    tag: "CAROUSEL",
    tagColor: "var(--src-blogs)",
    eyebrow: "LinkedIn \xB7 8 slides",
    ...
    format: "linkedin",
    genContext: genContext
  })), /*#__PURE__*/React.createElement(ShortsReel, {
    items: creator_brief?.shorts_ideas || [],
    topic: hero.topic,
    genContext: genContext
  }), /*#__PURE__*/React.createElement(QuickWins, {
