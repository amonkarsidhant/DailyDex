...
const OnboardingView = ({
  ...
  useEffect(() => {
    ...
    const logs = [{
      ...
      text: "Loading creator profile config templates...",
      type: "info"
    }, {
      ...
      text: "Probing available LLM providers on local PATH...",
      type: "info"
    }, {
      text: "Found local engines: gemini (cli), ollama (local), nvidia (nim)",
      type: "success"
    }, {
      text: `Configuring Copilot for provider: "${keys.llm_provider}"`,
      type: "info"
    }, {
      text: "Connecting to YouTube Data API sync engine...",
      type: "info"
    }, {
      text: keys.youtube_api_key ? "YouTube API Key verified." : "No YouTube Key provided. Falling back to scraper mode.",
      type: keys.youtube_api_key ? "success" : "warn"
    }, {
      text: "Loading fal.ai / Flux image generators...",
      type: "info"
    }, {
      text: keys.fal_api_key ? "fal.ai API key cached." : "No fal.ai key provided. Image generation will fall back to mockup grids.",
      type: keys.fal_api_key ? "success" : "warn"
    }, {
      text: "Running initial HackerNews trend indexing...",
      type: "info"
    }, {
      text: "Fetched and clustered 14 live developer opportunities.",
      type: "success"
    }, {
      text: "Creator Cockpit configuration saved successfully.",
      type: "success"
    }, {
      text: "DailyDex Autonomous Agents: ONLINE. Happy shipping! 🚀",
      type: "success"
    }];
