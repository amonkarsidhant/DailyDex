...
const BenchmarksView = () => {
  ...
  const presets = [{
    ...
    key: "frontier",
    label: "Frontier",
    hint: "40+ intelligence",
    test: b => b.intelligence_index >= 40
  }, {
    key: "fast",
    label: "Fast inference",
    hint: "150+ tok/s",
    test: b => b.speed_tokens_sec >= 150
  }, {
    key: "budget",
    label: "Budget",
    hint: "$1 or less",
    test: b => b.price_per_1m !== null && b.price_per_1m <= 1
  }, {
    key: "sweet",
  ...
  return /*#__PURE__*/React.createElement("div", {
  ...
  }, "MODEL SELECTION MATRIX"), /*#__PURE__*/React.createElement("h1", {
    style: {
      fontSize: 24,
      fontWeight: 600,
      color: "var(--text-hi)",
  ...
  }, "Find the capability, latency, and cost envelope that fits your workload.")), /*#__PURE__*/React.createElement("a", {
  ...
  }, "DATA: ARTIFICIAL ANALYSIS ->")), loading ? /*#__PURE__*/React.createElement("div", {
    className: "mono",
    style: {
      color: "var(--text-lo)"
    }
  }, "Loading benchmarks...") : error ? /*#__PURE__*/React.createElement("div", {
    style: {
      padding: 18,
  ...
  }, "Benchmark data unavailable: ", error) : /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("div", {
    style: {
      background: "var(--bg-1)",
  ...
  }, "QUICK CUTS"), /*#__PURE__*/React.createElement("div", {
    style: {
      display: "flex",
      flexWrap: "wrap",
      gap: 7
    ...
    placeholder: "Search Qwen, Claude...",
    style: controlStyle
  })), /*#__PURE__*/React.createElement("label", null, /*#__PURE__*/React.createElement("span", {
    className: "micro",
    style: {
  ...
  }, "MIN INTELLIGENCE"), /*#__PURE__*/React.createElement("input", {
    type: "number",
    min: "0",
    value: minIntelligence,
    onChange: e => setMinIntelligence(e.target.value),
    placeholder: "Any",
    style: controlStyle
  })), /*#__PURE__*/React.createElement("label", null, /*#__PURE__*/React.createElement("span", {
    className: "micro",
  ...
  }, "MIN TOKENS / SEC"), /*#__PURE__*/React.createElement("input", {
    type: "number",
    min: "0",
    value: minSpeed,
  ...
  }, "MAX $ / 1M OUTPUT"), /*#__PURE__*/React.createElement("input", {
    type: "number",
    min: "0",
    step: "0.1",
    value: maxPrice,
  ...
  }, "RANK BY"), /*#__PURE__*/React.createElement("select", {
    value: sortBy,
    onChange: e => setSortBy(e.target.value),
    style: controlStyle
  }, /*#__PURE__*/React.createElement("option", {
    value: "intelligence"
  }, "Intelligence: high to low"), /*#__PURE__*/React.createElement("option", {
    value: "speed"
  }, "Speed: high to low"), /*#__PURE__*/React.createElement("option", {
    value: "price"
  }, "Price: low to high"), /*#__PURE__*/React.createElement("option", {
    value: "name"
  }, "Model name: A to Z")))), /*#__PURE__*/React.createElement("div", {
    style: {
      padding: "9px 14px",
  ...
  }, rows.length), " OF ", benchmarks.length, " MODELS", activePreset.hint ? ` / ${activePreset.hint.toUpperCase()}` : ""), /*#__PURE__*/React.createElement("button", {
    className: "btn ghost",
    disabled: !hasFilters,
  ...
  }, "Output / 1M Tok ($)"))), /*#__PURE__*/React.createElement("tbody", null, rows.map((b, i) => /*#__PURE__*/React.createElement("tr", {
    key: b.model_name,
    style: {
  ...
  }, b.intelligence_index !== null ? b.intelligence_index.toFixed(1) : "N/A"), b.intelligence_index !== null && /*#__PURE__*/React.createElement("div", {
    style: {
      width: 100,
      height: 4,
      background: "var(--bg-3)",
    ...
    style: {
      width: `${Math.min(100, b.intelligence_index)}%`,
      height: "100%",
  ...
  }, b.speed_tokens_sec !== null ? Math.round(b.speed_tokens_sec) : "N/A")), /*#__PURE__*/React.createElement("td", {
    style: {
      padding: "12px 16px"
    }
  }, /*#__PURE__*/React.createElement("span", {
    className: "mono tnum",
    style: {
      color: b.price_per_1m === 0 ? "var(--signal-up)" : "var(--text)"
    }
  }, b.price_per_1m !== null ? b.price_per_1m === 0 ? "FREE" : `$${b.price_per_1m.toFixed(2)}` : "N/A")))), rows.length === 0 && /*#__PURE__*/React.createElement("tr", null, /*#__PURE__*/React.createElement("td", {
    colSpan: "4",
    style: {
      padding: "36px 16px",
      textAlign: "center",
