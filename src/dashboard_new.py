...
# ── Content pipeline: enrich, forge, editorial, publish, analytics ────────
# Extracted to routes/api_content.py
from routes.api_content import content_bp
app.register_blueprint(content_bp)


# ── Notion sync, Shorts repurposing, A/B testing ───────────────────────────
# Extracted to routes/api_integrations.py (real Notion API via notion_client.py)
