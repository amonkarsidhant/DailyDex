...
const ThumbsView = ({ onJump }) => {
  ...
  const allTopics = [...new Set(thumbnails.map(t => t.topic))];
  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
      ...
      <div className="panel" style={{ overflow: "hidden" }}>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "1.2fr 1fr", padding: "20px 24px", gap: 28 }}>
          {/* Big picked thumb */}
          <div>
            {(() => {
          ...
          {topicThumbs.map((t, i) => (
            <div key={t.id}
              ...
              <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between" }}>
                <span className="mono" style={{ fontSize: 10.5, color: "var(--text-mid)", letterSpacing: "0.05em" }}>{t.kind.toUpperCase()}</span>
